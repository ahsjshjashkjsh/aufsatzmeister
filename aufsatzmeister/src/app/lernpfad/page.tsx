...
const moduleThemes = [
  { iconBg: 'bg-blue-50',   iconText: 'text-blue-500',   activeBorder: 'hover:border-blue-300' },
  { iconBg: 'bg-green-50',  iconText: 'text-green-500',  activeBorder: 'hover:border-green-300' },
  { iconBg: 'bg-orange-50', iconText: 'text-orange-500', activeBorder: 'hover:border-orange-300' },
  { iconBg: 'bg-purple-50', iconText: 'text-purple-500', activeBorder: 'hover:border-purple-300' },
  { iconBg: 'bg-pink-50',   iconText: 'text-pink-500',   activeBorder: 'hover:border-pink-300' },
]
              ...
              <Link key={modul.id} href={isLocked ? '/settings' : `/lernpfad/${modul.id}`}>
                <div className={`
                  ...
                  ${done ? 'border-green-200 hover:border-green-400'
                    : isLocked ? 'border-stone-100 opacity-75 hover:opacity-100 hover:border-stone-200'
