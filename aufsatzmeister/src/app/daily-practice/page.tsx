...
export default function DailyPracticePage() {
  ...
  async function handleNext() {
    if (index < exercises.length - 1) { setIndex(i => i + 1); setSelected(null); setSubmitted(false) }
    else { setDone(true); await updateStreak() }
  }
      ...
      <div className="min-h-screen bg-[#FFFBF5]">
        ...
        <div className="md:ml-64 flex items-center justify-center min-h-screen">
          <div className="text-center max-w-sm px-6">
            ...
            <p className="text-2xl font-bold text-orange-500 mb-8">{Math.round((correct / exercises.length) * 100)}%</p>
