      ...
      <div className="min-h-screen bg-[#FFFBF5]">
        ...
        <div className="md:ml-64 flex items-center justify-center min-h-screen">
          <div className="text-center max-w-sm px-6">
            ...
            <p className="text-stone-400 mb-8">Morgen gibt es neue Wörter.</p>
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF5]">
      ...
      <div className="md:ml-64">
        <main className="px-6 py-8 pb-28 md:pb-10 max-w-md">
          ...
          <div className={`rounded-3xl border-2 mb-6 overflow-hidden shadow-sm transition-all ${revealed ? 'border-orange-200' : 'border-stone-200'}`}>
            <div className="bg-white p-8 text-center">
              <span className={`inline-block px-3 py-1 rounded-full text-xs font-bold mb-5 ${style.bg} ${style.text}`}>{style.label}</span>
              <h2 className="text-4xl font-extrabold text-stone-900">{word.word}</h2>
            </div>
            {revealed ? (
